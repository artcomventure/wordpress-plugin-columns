<div class="wrap">
	...
	<form id="columns-options-form" method="post" action="options.php">
		...
		<table class="form-table" style="display:none;">
			...
			<tr valign="top">
				<th scope="row"><?php _e( 'Maximum available columns', 'columns' ); ?>:</th>
				<td>
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<input type="checkbox" class="regular-checkbox" name="columns[responsive]"
			...
			foreach ( array( 'Tablet', 'Mobile' ) as $breakpoint ) : ?>
				...
				<tr valign="top">
					...
					<td>
						...
						<p class="description">
							<?php if ($breakpoint == 'Tablet') _e( 'Intermediate step. Larger column sets will be displayed in multiple rows.<br />For Example: <code>1x9</code> to <code>3x3</code>, <code>1x8</code> to <code>2x4</code>, <code>1x7</code> to <code>1x4 + 1x3</code>, ...', 'columns' );
							else _e( 'All columns will be displayed in a single column.', 'columns' ); ?>
						</p>
					</td>
				</tr>
